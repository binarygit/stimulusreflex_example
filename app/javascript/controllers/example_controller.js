...
export default class extends ApplicationController {
  ...
  //   console.log("dance enqueued for delivery upon connection", element, reflex, id)
  // }

  // danceDelivered(element, reflex, noop, id) {
  //   console.log("dance delivered to the server", element, reflex, id)
  // }

  // danceSuccess(element, reflex, noop, id) {
  //   console.log("dance successfully executed", element, reflex, id)
  // }

  // danceError(element, reflex, error, id) {
  //   console.error("dance server-side error", element, reflex, error, id)
  // }

  // danceHalted(element, reflex, noop, id) {
  //   console.warn("dance halted before execution", element, reflex, id)
  // }

  // danceForbidden(element, reflex, noop, id) {
  //   console.warn("dance forbidden from executing", element, reflex, id)
  // }

  // afterDance(element, reflex, noop, id) {
  //   console.log("dance has been executed by the server", element, reflex, id)
  // }

  // finalizeDance(element, reflex, noop, id) {
  //   console.log("dance changes have been applied", element, reflex, id)
  // }
}
